...
% calculate "errors" of nodes that are not input nodes
delta3 = a3 - y_matrix;
delta2 = delta3*Theta2(:,2:end) .* sigmoidGradient(z2);

% calculate big delta
bigDelta2 = delta3'*a2PlusBias;
bigDelta1 = delta2'*a1;

% calculate NON REGULARIZED gradients
unRegTheta2_grad = (1/m)*bigDelta2;
unRegTheta1_grad = (1/m)*bigDelta1;
